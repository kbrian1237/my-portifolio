...
const textArray = ["Computer Scientist", "Software Developer", "Full Stack Developer", "AI Developer", "UI/UX Designer", "Mobile App Developer"];
...
document.querySelectorAll('.skill-card, .project-card, .contact-item, .about-text, .figma-card, .language-icon').forEach(el => {
    el.style.opacity = '0';
...
document.querySelectorAll('.project-card, .figma-card').forEach(card => {
